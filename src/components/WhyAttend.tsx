...
const learnings = [
  {
    Icon: HelpCircle,
    title: 'What Are They?',
    subtitle: 'Understanding Scientific Conferences',
    desc: 'Get a clear, jargon-free explanation of what international scientific conferences are, who they are for, and how they differ from regular academic events.',
    accent: '#FF1F1F',
    num: '01',
  },
  {
    ...
    subtitle: 'Get a Crossref DOI for Your Abstract',
  ...
  },
  {
    Icon: Mic,
    title: 'Keynote Path',
    subtitle: 'How to Become a Keynote Speaker',
  ...
  },
  {
    ...
    subtitle: 'Google Scholar & 10+ Directories',
    desc: 'Find out how your abstract gets indexed in Google Scholar and 10+ international research directories — boosting your academic visibility across the globe.',
    accent: '#FF1F1F',
    num: '05',
  },
  {
    Icon: Database,
    title: 'CPD Credits',
    subtitle: 'What Is CPD & Why It Matters',
    desc: 'Learn what Continuing Professional Development (CPD) credits are, why professional bodies value them, and how one webinar or conference can earn you accredited CPD credits.',
    accent: '#C70000',
    num: '06',
  },
];
